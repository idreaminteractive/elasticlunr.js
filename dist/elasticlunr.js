...
function () {
  ...
  _createClass(Index, [{
    ...
    /** Individual elements */
    value: function getDocumentStore() {
  ...
  _createClass(Token, [{
    ...
    value: function update(fn) {
      ...
      if (Array.isArray(out) && out.length === 2) {
        this.token = out[0];
        this.metadata = _objectSpread({}, this.metadata, out[1]);
        return this;
      }
  ...
  _createClass(Field, [{
    ...
    value: function add(documents) {
      ...
      try {
        ...
        for (var _iterator2 = documents[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          _loop2();
        }
      } catch (err) {
...
function (_IdxInterface) {
  ...
  function Index(options) {
    ...
    _this8 = _possibleConstructorReturn(this, _getPrototypeOf(Index).call(this, options));
...
function (_Query) {
  ...
  function NotQuery(innerQuery) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(NotQuery).call(this, innerQuery));
...
function (_Query2) {
  ...
  function BoolQuery(options) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(BoolQuery).call(this, options));
...
function (_Query3) {
  ...
  function TermsQuery(options) {
    ...
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(TermsQuery).call(this, options));
...
function (_Query4) {
  ...
  function MatchAllQuery(options) {
    ...
    _this5 = _possibleConstructorReturn(this, _getPrototypeOf(MatchAllQuery).call(this, options));
...
function (_Query5) {
  ...
  function MatchQuery(options) {
    ...
    _this7 = _possibleConstructorReturn(this, _getPrototypeOf(MatchQuery).call(this, options));
...
function () {
  function Converter(inner, options) {
    ...
    if (!(inner instanceof Index)) throw Error('The object provided must be an instance of the index interface');
    this.inner = inner;
  ...
  _createClass(Converter, [{
    ...
    value: function elasticsearch(query) {
      ...
      var q = QueryRepository.parse(keys[0][0], keys[0][1], root);
...
function () {
  ...
  _createClass(IndexAssembly, [{
    ...
    value: function loadIndex(data) {
      ...
      try {
        for (var _iterator = this.knownVersions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var o = _step.value;
    ...
    value: function createDefault() {
      ...
      try {
        for (var _iterator2 = this.knownVersions[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var o = _step2.value;
...
function index (elasticlunr) {
  var newIndexShim = function newIndexShim(elasticlunr) {
    return function (components) {
      ...
      var objE = new Converter(new Index$1({
        storePositions: true,
  ...
  var _split = function _split(str) {
    ...
    while (lastIndex < str.length) {
      ...
      if (newIndex.index > lastIndex) {
        tokens.push(new Token(str.substring(lastIndex, newIndex.index).trim().toLowerCase(), {
          start: lastIndex,
          end: newIndex.index
        }));
      }
...
[utils, index, //  invertedIndex,
configuration, eventEmitter, pipeline, documentStore, sortedSet, tokenizer, stemmer, stopWordFilter, trimmer].forEach(function (mod) {
  mod(elasticlunr);
}); // elasticlunr.version = __VERSION__;
module.exports = exports["default"];

module.exports = elasticlunr;
//# sourceMappingURL=elasticlunr.js.map
